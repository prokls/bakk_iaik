...
\section{Obtain CNF and DNF from truthtable}
\label{sec:cnf-dnf}
%
\index{Truthtable}
...
% TODO: I can't recall. Did Pawel provide some research here? Also see emails!
...
The interface is only introduced for clarification of the function names used in the algorithms following. Some C++ keywords are left out for brevity.

\lstset{language={C++},caption={SAT solver abstraction interface}}
\begin{lstlisting}
  class ISatSolver {
